class ArticlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @article.save
        format.html { redirect_to @article.page, notice: 'Article was successfully created.' }
        format.mobile { redirect_to @article.page, notice: 'Article was successfully created.' }
      else
